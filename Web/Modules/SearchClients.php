...
/**
 * Search engine for searching in clients.
 *
 * @author Marcin Haba <marcin.haba@bacula.pl>
 * @category Module
 */
class SearchClients extends SearchResourceBase implements ISearchCategory
{
	/**
	...
	{
		return 'fa-solid fa-desktop fa-fw';
	}
