	...
	<com:TActiveRepeater ID="FileList">
		...
		<prop:ItemTemplate>
			<tr class="row">
				...
				<td style="overflow-wrap: anywhere; word-break: break-word;"><%#$this->Data->file_fmt ?? \Bacularis\Common\Modules\Miscellaneous::html_value($this->Data->file)%></td>
