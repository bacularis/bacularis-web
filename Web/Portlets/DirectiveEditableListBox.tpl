<div class="directive_field w3-row<%=!$this->display_directive ? ' hide' : '';%>">
	<div class="w3-col w3-quarter">
		...
		<div class="w3-right" style="width: 24px; padding-top: 9px;"><i class="fa-solid <%=$this->text_mode ? 'fa-list' : 'fa-edit'%> pointer" onclick="oDirectiveEditableListBox.switch_mode(this);"></i></div>
	</div>
